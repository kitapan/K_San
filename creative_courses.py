creative_course_options = {
    ...
    'web_coding': [
        ...
        "第11回 11-8 操作映像",
        "第11回 11-9 ナレッジ映像",
        "第11回 課題11-1課題01作成のヒント",
        "第11回 課題11-2課題02作成のヒント",
        "第12回 12-1 ナレッジ映像",
        "第12回 12-2 操作映像",
        "第12回 12-3 ナレッジ映像",
        "第12回 12-4 操作映像",
    ...
    'web_coding_advance': [
        "1-1 この講座で学習すること",
        "1-2 クリック時のボタンの色の変更",
        "2-1 マウスを合わせた時のボタンの色の変更",
        "2-2 ヘッダーの固定",
        "3-1 商品画像にボタンを表示",
        "3-2 TOP画像にスライダーを設定",
        "4-1 商品説明タブの切り替え",
        "4-2 サイズ選択に合わせた枠の表示",
        "5-1 在庫切れサイズ選択時のアラート表示",
        "5-2 商品選択時のボタンの切り替え",
        "6-1 カートアイコンの数値の加算",
        "6-2 商品画像の切り替え表示",
        "7-1 商品の数量と合計金額の連動",
        "7-2 商品の削除と合計金額の連動",
        "8-1 商品の表示と連動するボタン",
        "8-2 在庫切れサイズ選択時のアラート表示",
        "9-1 注文確定後に確認モーダルウィンドウを表示",
        "10-1 レスポンシブ対応"  
    ],
